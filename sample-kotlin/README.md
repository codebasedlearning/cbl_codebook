...
root of its own) or run the snippet from the IDE.
...
- `cbl.properties` — codebook properties
- `docs/glossary.md` — Kotlin glossary; headings are the referenceable blocks
- `docs/answers.md` — answers and background for the question blocks
